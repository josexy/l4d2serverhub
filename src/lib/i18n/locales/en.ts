export const en = {
  ...
  favoriteGroupPicker: {
    title: "Save favorite",
    description: "Choose where to save this server, or create a new group.",
    defaultGroup: "Default Group",
    loading: "Loading groups...",
    loadFailed: "Could not load favorite groups.",
    retry: "Retry",
    chooseGroup: "Group",
    chooseGroupPlaceholder: "Choose a group",
    newGroup: "New group",
    newGroupName: "Group name",
    newGroupPlaceholder: "Campaign crew",
    groupNameRequired: "Enter a group name first.",
    createGroup: "Create group",
    groupCreateSuccess: "Group created.",
    groupCreateFailed: "Could not create the group.",
    saveFavorite: "Save favorite",
    saveSuccess: "Favorite added.",
    saveFailed: "Could not save the favorite.",
  },
  serverDetail: {
